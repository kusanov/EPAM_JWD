package by.epam.kusanov.restaurant.dao.connection;
...
public final class ConnectionPool {
    ...
    private ConnectionPool() {
        ...
        } catch (NumberFormatException e) { poolSize = 5;
        }
    }
    ...
    public void initPoolData() throws ExceptionConnectionPool {
        ...
        try {
            ...
            throw new ExceptionConnectionPool("SQLException in ConnectionPool",e);
        } catch (ClassNotFoundException e) {
            throw new ExceptionConnectionPool(
 ...
 //logger.log(Level.ERROR, "Error closing the connection.", e);
    ...
    public Connection takeConnection() throws ExceptionConnectionPool { Connection connection = null;
        try {
